...
import type { CardData, CardToken } from "@/features/payments/types/card.types";
...
export default function Cards({
  ...
  return (
    <div className="max-w-lg h-full max-h-33.75 flex gap-2 overflow-y-auto mb-6 transition-all duration-200">
      {cards.length === 0 ? (
        <div
          className={clsx(
            styles.noCards,
